...
class KelasDua extends StatefulWidget {
  const KelasDua({Key? key}) : super(key: key);

  @override
  State<KelasDua> createState() => _KelasDuaState();
}

class _KelasDuaState extends State<KelasDua> {
  @override
