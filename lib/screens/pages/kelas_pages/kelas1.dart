...
class KelasSatu extends StatefulWidget {
  const KelasSatu({Key? key}) : super(key: key);

  @override
  State<KelasSatu> createState() => _KelasSatuState();
}

class _KelasSatuState extends State<KelasSatu> {
  @override
