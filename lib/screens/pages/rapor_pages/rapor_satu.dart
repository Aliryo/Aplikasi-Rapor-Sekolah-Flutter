...
import 'package:skripsi_rapor_sd/widgets/newrapor/new_rapor.dart';

class RaporSatu extends StatefulWidget {
  const RaporSatu({Key? key}) : super(key: key);

  @override
  State<RaporSatu> createState() => _RaporSatuState();
}

class _RaporSatuState extends State<RaporSatu> {
  @override
        ...
        body: Container(
          ...
          child: Column(
            children: [
              Expanded(
                child: StreamBuilder(
                    stream: DatabaseService().raporSatu,
