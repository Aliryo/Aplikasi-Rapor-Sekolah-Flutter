...
import 'package:skripsi_rapor_sd/widgets/newrapor/new_raporempat.dart';

class RaporEmpat extends StatefulWidget {
  const RaporEmpat({Key? key}) : super(key: key);

  @override
  State<RaporEmpat> createState() => _RaporEmpatState();
}

class _RaporEmpatState extends State<RaporEmpat> {
  @override
        ...
        body: Container(
          ...
          child: Column(
            children: [
              Expanded(
                child: StreamBuilder(
                    stream: DatabaseService().raporEmpat,
