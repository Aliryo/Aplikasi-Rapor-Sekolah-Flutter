...
import 'package:skripsi_rapor_sd/widgets/newrapor/new_rapordua.dart';

class RaporDua extends StatefulWidget {
  const RaporDua({Key? key}) : super(key: key);

  @override
  State<RaporDua> createState() => _RaporDuaState();
}

class _RaporDuaState extends State<RaporDua> {
  @override
        ...
        body: Container(
          ...
          child: Column(
            children: [
              Expanded(
                child: StreamBuilder(
                    stream: DatabaseService().raporDua,
