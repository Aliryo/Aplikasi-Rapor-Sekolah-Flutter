...
import 'package:skripsi_rapor_sd/widgets/newrapor/new_raportiga.dart';

class RaporTiga extends StatefulWidget {
  const RaporTiga({Key? key}) : super(key: key);

  @override
  State<RaporTiga> createState() => _RaporTigaState();
}

class _RaporTigaState extends State<RaporTiga> {
  @override
        ...
        body: Container(
          ...
          child: Column(
            children: [
              Expanded(
                child: StreamBuilder(
                    stream: DatabaseService().raporTiga,
